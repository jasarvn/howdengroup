...
{
    public class infoTechEmployeeController : Controller
    {
        public InfoTechEmployeeModel query = new InfoTechEmployeeModel();
        private readonly ILogger<infoTechEmployeeController> _logger;
        ...
        public infoTechEmployeeController(ILogger<infoTechEmployeeController> logger)
        {
            _logger = logger;
        }
